...
const (
	OrchestratorService_SubmitPipeline_FullMethodName = "/orchestrator.v1.OrchestratorService/SubmitPipeline"
)
...
func (c *orchestratorServiceClient) SubmitPipeline(ctx context.Context, in *SubmitPipelineRequest, opts ...grpc.CallOption) (*SubmitPipelineResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SubmitPipelineResponse)
	err := c.cc.Invoke(ctx, OrchestratorService_SubmitPipeline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrchestratorServiceServer) SubmitPipeline(context.Context, *SubmitPipelineRequest) (*SubmitPipelineResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitPipeline not implemented")
}
...
func _OrchestratorService_SubmitPipeline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitPipelineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrchestratorServiceServer).SubmitPipeline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrchestratorService_SubmitPipeline_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrchestratorServiceServer).SubmitPipeline(ctx, req.(*SubmitPipelineRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _OrchestratorService_SubmitPipeline_Handler,
		},
	},
