...
func main() {
	...
	// TODO: Initialize PostgreSQL repository for model metadata
	...
	go func() {
		...
		// TODO: Register model registry service
		// model_registryv1.RegisterModelRegistryServiceServer(grpcServer, NewModelRegistryGRPCServer(logger, repo))
